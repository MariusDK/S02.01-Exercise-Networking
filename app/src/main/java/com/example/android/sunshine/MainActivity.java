...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            URL preferredLocation = NetworkUtils.buildUrl(SunshinePreferences.getPreferredWeatherLocation(this));
            new AsyncTask().execute(preferredLocation);
        }
    ...
    public class AsyncTask extends android.os.AsyncTask<URL,Void,String[]>
    {
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try {
                weatherSearchResults = NetworkUtils.getResponseFromHttpUrl(search);

                simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,weatherSearchResults);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
